...
<body>
	<form action="<%= request.getContextPath() %>/book/add" method="post" enctype="multipart/form-data">
		<fieldset>
	...
	<h3><a href="<%= request.getContextPath() %>/openBookDashBoardPage">Go to Books List</a></h3>
</body>
</html>